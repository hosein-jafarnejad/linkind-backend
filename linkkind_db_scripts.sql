...
ALTER TABLE USERS ALTER COLUMN CREATTION_DATE SET DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE LINKS ALTER COLUMN CREATION_DATE SET DEFAULT CURRENT_TIMESTAMP;
