...
public interface LinkMapper {
    @Insert("INSERT INTO " +
            ...
            "VALUES(nextval('SLINKS'), #{link.url}, #{link.owner}, #{link.shortUrl})")
    ...
    @Select("SELECT URL FROM LINKS WHERE SHORT_URL = #{shortUrl}")
    String getWithShortUrl(@Param("shortUrl") String shortUrl);
